...
export class ProducerController {
    ...
    static async store(req: RequestTemporary, res: Response, next: NextFunction) {
        ...
        const metadata = await ProducerService.create(validate.value)
    ...
    static async index(req: Request, res: Response, next: NextFunction) {
        let metadata = await ProducerService.getDatas(req)
    ...
    static async show(req: Request, res: Response, next: NextFunction) {
        ...
        const metadata = await ProducerService.getById(id)
    ...
    static async put(req: Request, res: Response, next: NextFunction) {
        ...
        const foundSchedule= await ProducerService.getById(id)

        if (!foundSchedule) {
            throw new NotFoundRequestError()
        }

        const metadata = await ProducerService.update(id, req.body)
        new OK({
            message: "success",
            metadata: metadata
        }).send(res);
    ...
    static async destroy(req: Request, res: Response, next: NextFunction) {
        ...
        const metadata = await ProducerService.deleteById(id)
